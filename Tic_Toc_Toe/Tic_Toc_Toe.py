...
def CheckForWin():
    if(button1["text"] == 'X' and button2["text"] == 'X' and button3["text"] == 'X' or
       ...
       button3["text"] == 'X' and button5["text"] == 'X' and button7["text"] == 'X'):
        disableButton()
        tkinter.messagebox.showinfo("Tic-Toc-Toe", pa)
...
button10 = Button(tk, text="Reset", font='Times 20 bold', bg='gray',
                  fg='white', height=2, width=8, command=lambda: btnClick(button10))
